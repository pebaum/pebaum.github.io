...
for lex_id, info in LEXICONS.items():
    ...
    try:
        ...
        print(f"   [OK] Downloaded to {filepath.name}")
...
print(f"[OK] Parsed {len(nrc_vad_data):,} words with VAD scores\n")
...
print(f"[OK] Parsed {len(nrc_emo_data):,} words with emotion labels\n")
...
print(f"[OK] Parsed {len(depechmood_data):,} words with emotion scores\n")
...
print(f"\n[OK] Merged {len(unified_database):,} words!\n")
