...
- **Glissando**: Cello and Vibraphone can smoothly glide between notes
...
|------------|-----------|----------|------|
| **Cello** | Warm, sustained, expressive glides | Triangle | Foundation, drones |
| **Celeste** | Bell-like, crystalline shimmer | Sine | Sparkle, accents |
| **Harp** | Plucked, resonant | Triangle | Arpeggios, sweeps |
| **Rhodes** | Electric piano warmth, tremolo | Triangle | Chordal pads |
| **Vibraphone** | Metallic shimmer, motor-driven glides | Sine | Accents, color |
...
Chords can be arpeggiated rather than played simultaneously. Each instrument has its own arpeggio tendency:
- **Harp** (55%): Natural harp arpeggiation with quick sweeps
- **Celeste** (35%): Sparkling, rapid arpeggios
- **Vibraphone** (25%): Mallet rolls with moderate speed
- **Rhodes** (20%): Jazzy chord rolls
- **Cello** (12%): Slow, stately arpeggios
...
- **Random (⤳)**: Notes in random order
- **Inside-Out (⥮)**: Middle notes first, then outer
### Chord Generation
